...
public interface IHoleFeatureProxy
{
    ...
    void SetDistanceExtent(object Depth, PartFeatureExtentDirectionEnum ExtentDirection, bool FlatBottom, object BottomTipAngle);

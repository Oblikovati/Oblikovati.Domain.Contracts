...
public interface IHoleTableStyle
{
    ...
    void AddColumn(HolePropertyEnum PropertyType, string CustomPropertyName, string Title, double Width, HorizontalTextAlignmentEnum TitleHorizontalJustification, HorizontalTextAlignmentEnum ValueHorizontalJustification);

...
public interface IDerivedAssemblyDefinition
{
    ...
    void GetHolePatchingOptions(out DerivedHolePatchEnum HolePatchType, out double MinimumPerimeter, out double MaximumPerimeter, out IEdgeCollection Reserved);
    void GetRemoveBySizeOptions(out bool Enable, out int SizeRatioPercentage);
    void GetRemoveByVisibilityOptions(out DerivedGeometryRemovalEnum GeometryToRemove, out int VisibilityPercentage, out bool IgnoreSurfaceFeatures);
    void SetHolePatchingOptions(DerivedHolePatchEnum HolePatchType, double MinimumPerimeter, double MaximumPerimeter, object Reserved);
    void SetRemoveBySizeOptions(bool Enable, int SizeRatioPercentage);
    void SetRemoveByVisibilityOptions(DerivedGeometryRemovalEnum GeometryToRemove, int VisibilityPercentage, bool IgnoreSurfaceFeatures);

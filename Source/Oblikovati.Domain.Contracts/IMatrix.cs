...
public interface IMatrix
{
    ...
    void SetToAlignCoordinateSystems(IPoint FromOrigin, IVector FromXAxis, IVector FromYAxis, IVector FromZAxis, IPoint ToOrigin, IVector ToXAxis, IVector ToYAxis, IVector ToZAxis);
    void SetToIdentity();

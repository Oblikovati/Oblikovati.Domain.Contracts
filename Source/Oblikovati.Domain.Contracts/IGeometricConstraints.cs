...
public interface IGeometricConstraints : IList<IGeometricConstraints>
{
    ...
    ICollinearConstraint AddCollinear(ISketchEntity EntityOne, ISketchEntity EntityTwo, bool UseEllipseOneMajorAxis, bool UseEllipseTwoMajorAxis);
    ...
    IParallelConstraint AddParallel(ISketchEntity EntityOne, ISketchEntity EntityTwo, bool UseEllipseOneMajorAxis, bool UseEllipseTwoMajorAxis);
    IPerpendicularConstraint AddPerpendicular(ISketchEntity EntityOne, ISketchEntity EntityTwo, bool UseEllipseOneMajorAxis, bool UseEllipseTwoMajorAxis);

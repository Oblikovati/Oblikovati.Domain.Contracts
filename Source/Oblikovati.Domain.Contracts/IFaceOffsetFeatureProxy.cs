...
public interface IFaceOffsetFeatureProxy
{
    ...
    IFaceOffsetDefinition _Definition { get; set; }
    ISurfaceBodies _OutputBodies { get; }
    IFaceOffsetFeature NativeObject { get; }
    ...
    void _Edit(IFaceCollection InputFaces, object Distance, bool reverse, bool autoFaceChain, bool vOptimized, object vTol, FeatureApproximationTypeEnum approxType);
}

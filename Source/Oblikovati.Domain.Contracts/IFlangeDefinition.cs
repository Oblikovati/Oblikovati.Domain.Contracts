...
public interface IFlangeDefinition
{
    ...
    void SetDistanceHeightExtent(object Distance, PartFeatureExtentDirectionEnum ExtentDirection, HeightDatumTypeEnum HeightDatumType);
    void SetEdgeWidthExtent(IEdge Edge);
    void SetFromToWidthExtent(IEdge Edge, object FromEntity, object ToEntity);
    void SetLegacyDistanceHeightExtent(object Distance, PartFeatureExtentDirectionEnum ExtentDirection, HeightDatumTypeEnum HeightDatumType);
    void SetOffsetWidthExtent(IEdge Edge, object OffsetEntityOne, object OffsetDistanceOne, object OffsetEntityTwo, object OffsetDistanceTwo);
    void SetToHeightExtent(object ToEntity, object Offset);
    void SetWidthOffsetWidthExtent(IEdge Edge, object Width, object OffsetDistance, object OffsetEntity, bool PositiveDirection);
    ...
    void SetOffsetDefaultWidthExtent(object OffsetEntityOne, object OffsetDistanceOne, object OffsetEntityTwo, object OffsetDistanceTwo);
    void SetWidthOffsetDefaultWidthExtent(object Width, object OffsetDistance, object OffsetEntity, bool PositiveDirection);

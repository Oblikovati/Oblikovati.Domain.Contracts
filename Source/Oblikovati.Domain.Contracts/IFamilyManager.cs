...
public interface IFamilyManager
{
    ...
    string GetFamilyTable2(string FamilyId, string LibraryId, bool FullyPopulated, ContentCenterDecimalMarkerOptionEnum decimalMarker);
    INameValueMap GetEvaluatedRow(string FamilyId, string RowId, string LibraryId, object ColumnIds, object ParameterValueOverrides, ContentCenterDecimalMarkerOptionEnum decimalMarker);
}

...
public interface ICombineFeatureProxy
{
    ...
    ISurfaceBodies ToolBodies { get; }
    ICombineFeature NativeObject { get; }
    ...
    void Edit(ISurfaceBody BaseBody, IObjectCollection ToolBodies, PartFeatureOperationEnum Operation);
}

...
public interface IPresentationDocument
{
    ...
    IPresentationExplodedViews PresentationExplodedViews { get; }
    IPresentationExplodedView ActiveExplodedView { get; }
    ...
    IPublications Publications { get; }
    IPublication ActivePublication { get; }
    bool IsMultiTopComponentsDisabled { get; }
    IPresentationEvents PresentationEvents { get; }
    IPresentationScenes Scenes { get; }
    IPresentationScene ActiveScene { get; }
    ...
    void GetMissingAddInBehavior(out string ClientId, out CommandTypesEnum DisabledCommandTypesEnum, out IObjectCollection DisabledCommands);
    ...
    void _PutInternalNameAndFileVersion(string Name, string Number, string Custom, string Revision, out string InternalName, out string FileVersion);

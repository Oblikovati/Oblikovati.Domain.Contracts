...
public interface ISurfaceBodyProxy
{
    ...
    void GetAppearanceTextureMappingData(out TextureMappingTypeEnum TextureMappingType, out object TextureMappingAlignment);

...
public interface IIRxCurve2dEvaluator
{
    IIRxBox2d RangeBox { get; }
    uint Continuity { get; }
    ...
    void GetParamAtPoint(uint nPoints, double pPoints, ref double pGuessParams, ref double pMaxDeviations, ref double pParams, ref SolutionNatureEnum pSolutionNatures);

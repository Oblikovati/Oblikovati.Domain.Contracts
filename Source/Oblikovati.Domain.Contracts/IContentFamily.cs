...
public interface IContentFamily
{
    ...
    string CreateMember(object Row, out MemberManagerErrorsEnum FailureReason, out string FailureMessage, ContentMemberRefreshEnum Refresh, bool Custom, string FileName, object CustomInput, object Options);

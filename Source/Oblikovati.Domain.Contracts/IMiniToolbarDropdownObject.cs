...
public interface IMiniToolbarDropdownObject
{
    ...
    void Delete();
    IMiniToolbarListItem AddItem(string Text, string ToolTipText, string InternalName, bool AllowDelete, bool ShowCheckBox, object StandardIcon, object LargeIcon, int Index);

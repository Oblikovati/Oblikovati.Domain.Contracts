...
public interface ITransientGeometry
{
    ...
    IArc3d CreateArc3d(IPoint Center, IUnitVector Normal, IUnitVector ReferenceVector, double Radius, double StartAngle, double SweepAngle);
    ...
    IEllipticalArc CreateEllipticalArc(IPoint Center, IUnitVector MajorAxis, IUnitVector MinorAxis, double MajorRadius, double MinorRadius, double StartAngle, double SweepAngle);
    IEllipticalArc2d CreateEllipticalArc2d(IPoint2d Center, IUnitVector2d MajorAxis, double MajorRadius, double MinorRadius, double StartAngle, double SweepAngle);
    ...
    IBSplineCurve CreateBSplineCurve(int Order, ref List<double> Poles, ref List<double> Knots, ref List<double> Weights, bool IsPeriodic);
    IBSplineCurve2d CreateBSplineCurve2d(int Order, ref List<double> Poles, ref List<double> Knots, ref List<double> Weights, bool IsPeriodic);
    ...
    IEllipticalCylinder CreateEllipticalCylinder(IPoint BasePoint, IUnitVector AxisVector, IVector MajorAxisVector, double MinorMajorRatio);
    ICone CreateCone(IPoint RootPoint, IUnitVector Axis, double Radius, double HalfAngle, bool IsExpanding);
    IEllipticalCone CreateEllipticalCone(IPoint BasePoint, IUnitVector AxisVector, IVector MajorAxisVector, double MinorMajorRatio, double HalfAngle, bool IsExpanding);
    ...
    IBSplineSurface CreateBSplineSurface(List<int> Order, List<double> Poles, List<double> KnotsU, List<double> KnotsV, List<double> Weights, List<bool> IsPeriodic);

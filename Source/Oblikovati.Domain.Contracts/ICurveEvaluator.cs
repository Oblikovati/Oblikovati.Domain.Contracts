...
public interface ICurveEvaluator
{
    ...
    void GetParamAtPoint(ref List<double> Points, ref List<double> GuessParams, ref List<double> MaxDeviations, ref List<double> Params, ref List<SolutionNatureEnum> SolTypes);
    ...
    void GetStrokes(double FromParam, double ToParam, double Tolerance, out int VertexCount, out List<double> VertexCoordinates);
}

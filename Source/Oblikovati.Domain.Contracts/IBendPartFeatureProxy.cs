...
public interface IBendPartFeatureProxy
{
    ...
    IParameter InputOne { get; }
    IParameter InputTwo { get; }
    IBendPartFeature NativeObject { get; }
    ...
    void Edit(ISketchLine BendLine, BendPartTypeEnum BendPartType, object InputOne, object InputTwo, PartFeatureExtentDirectionEnum BendSide, bool BendInSketchNormalDirection, object Body, bool BendMinimum);
}

...
public interface IBrowserPanes : IList<IBrowserPane>
{
    ...
    IClientBrowserNodeDefinition CreateBrowserNodeDefinition(string Label, int Id, IClientNodeResource Icon, object ToolTipText, object ExpandedIcon, object DisplayState, object StateIconToolTipText);
    IBrowserPane AddTransientTreeBrowserPane(string Name, string InternalName, IBrowserNodeDefinition TopNodeDefinition);

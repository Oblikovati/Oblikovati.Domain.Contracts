...
public interface IMemberManager
{
    ...
    object EvaluateTableExpression(string Expression, GeneralDataTypeEnum ValueType, string DefaultUnitType, bool AsValue, string Moniker, string LibraryId, object CustomParameters);
    string GetInstance(string Moniker, out ContentCenterInstanceStatusEnum InstanceStatus, string LibraryId, object CustomParameters, string FullFileName);
    ...
    string GetMemberCategorization(ref List<string> Categories, string FamilyParamMap, string Table, string TemplateParams);
    void GetDefaultTableWithMap(string MemberCategorization, string TemplateFile, ref List<string> Categories, out string DefaultTable, out string FamilyParamMap, out string TemplateParams);

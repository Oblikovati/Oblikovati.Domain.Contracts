...
public interface ISurfaceEvaluator
{
    ...
    void GetParamAtPoint(ref List<double> Points, ref List<double> GuessParams, ref List<double> MaxDeviations,
        ref List<double> Params, ref List<SolutionNatureEnum> SolutionNatures);
    ...
    void GetCurvatures(ref List<double> Params, ref List<double> MaxTangents, ref List<double> MaxCurvatures,
        ref List<double> MinCurvatures);

    void GetFirstDerivatives(ref List<double> Params, ref List<double> UPartials, ref List<double> VPartials);

    void GetSecondDerivatives(ref List<double> Params, ref List<double> UUPartials, ref List<double> UVPartials,
        ref List<double> VVPartials);

    void GetThirdDerivatives(ref List<double> Params, ref List<double> UUUPartials, ref List<double> VVVPartials);

    void GetParamAnomaly(ref List<double> PeriodicityU, ref List<double> PeriodicityV, out int NumEndSingularitiesU,
        ref List<double> SingularitiesU, out int NumEndSingularitiesV, ref List<double> SingularitiesV,
        ref List<bool> UnboundedParams);

...
public interface ISketchEquationCurve
{
    ISketch Parent { get; }
    ...
    void GetEquation(out CurveEquationTypeEnum EquationType, out CoordinateSystemTypeEnum CoordinateSystemType,
        out string XValueOrRadius, out string YValueOrTheta, out IParameter MinValue, out IParameter MaxValue);

    void SetCustomLineType(string FullFileName, string LineTypeName, bool ReplaceExisting);

    void SetEquation(CurveEquationTypeEnum EquationType, CoordinateSystemTypeEnum CoordinateSystemType,

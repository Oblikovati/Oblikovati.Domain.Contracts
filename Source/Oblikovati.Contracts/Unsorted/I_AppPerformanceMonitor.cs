...
public interface I_AppPerformanceMonitor
{
    ...
    void GetASMMemoryTotals(out long Allocations, out long DeAllocations, out int BytesAllocated,
    ...
    void OutputMemoryStatistics(string EntryName, out string CommittedMem, out string ReservedMem,
        out string WastedMem);
}
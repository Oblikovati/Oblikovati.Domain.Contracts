...
public interface IFileUIEvents
{
    ...
    /// </summary>
    EventHandler<OnFileNewDialogEventArgs> OnFileNewDialog { get; set; }
    ...
    /// </summary>
    EventHandler<OnFileOpenDialogEventArgs> OnFileOpenDialog { get; set; }
    ...
    /// </summary>
    EventHandler<OnFileSaveAsDialogEventArgs> OnFileSaveAsDialog { get; set; }
    ...
    /// within an assembly.
    /// </summary>
    EventHandler<OnFileInsertNewDialogEventArgs> OnFileInsertNewDialog { get; set; }
    ...
    /// </summary>
    EventHandler<OnFileInsertDialogEventArgs> OnFileInsertDialog { get; set; }
    ...
    /// </summary>
    EventHandler<OnFileOpenFromMRUEventArgs> OnFileOpenFromMRU { get; set; }
    ...
    /// </summary>
    EventHandler<OnFileNewEventArgs> OnFileNew { get; set; }
    ...
    /// </summary>
    EventHandler<OnPopulateFileMetadataEventArgs> OnPopulateFileMetadata { get; set; }

...
public interface IFaceOffsetFeatureProxy
{
    ...
    void _Edit(IFaceCollection InputFaces, object Distance, bool reverse, bool autoFaceChain, bool vOptimized,
        object vTol, FeatureApproximationTypeEnum approxType);
}
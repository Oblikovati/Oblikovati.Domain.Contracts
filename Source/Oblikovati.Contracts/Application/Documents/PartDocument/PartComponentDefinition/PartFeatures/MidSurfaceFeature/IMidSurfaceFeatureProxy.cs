...
public interface IMidSurfaceFeatureProxy
{
    ...
    ISurfaceBodies _InputBodies { get; }
    ISurfaceBodies _OutputBodies { get; }
    IMidSurfaceThicknesses _Thicknesses { get; }
    IMidSurfaceFeature NativeObject { get; }
    ...
    void _Edit(IObjectCollection InputBodies);
}
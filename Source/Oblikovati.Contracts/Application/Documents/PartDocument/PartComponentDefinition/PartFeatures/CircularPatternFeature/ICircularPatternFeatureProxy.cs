...
public interface ICircularPatternFeatureProxy
{
    ...
    ICircularPatternFeatureDefinition Definition { get; set; }
    ICircularPatternFeature NativeObject { get; }

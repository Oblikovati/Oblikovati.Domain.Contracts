...
public interface IUnfoldMethod
{
    ...
    void GetEquation(int Index, out string Equation, out string MinimumValue,
        out ComparisonTypeEnum MinimumCompareCondition, out string BoundedVariable, out string MaximumValue,
        out ComparisonTypeEnum MaximumCompareCondition);

    void SetEquation(int Index, UnfoldMethodEquationTypeEnum EquationType, string Equation, string MinimumValue,
        ComparisonTypeEnum MinimumCompareCondition, string BoundedVariable, string MaximumValue,
        ComparisonTypeEnum MaximumCompareCondition);
}
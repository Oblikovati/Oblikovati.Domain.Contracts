...
public interface IPartsListStyle
{
    ...
    void AddColumn(PropertyTypeEnum PropertyType, string PropertySetId, object PropertyIdentifier, string Title,
        double Width, HorizontalTextAlignmentEnum TitleHorizontalJustification,

...
public interface IDrawingStandardStyle
{
    ...
    void GetViewLabelDefaults(DrawingViewTypeEnum ViewType, out string Prefix, out bool Visible,
        out string FormattedText, out bool ConstrainToBorder, out bool PlaceBelowView);

    void SetViewLabelDefaults(DrawingViewTypeEnum ViewType, string Prefix, bool Visible, string FormattedText,
        bool ConstrainToBorder, bool PlaceBelowView);
}
...
public interface IRevisionTableStyle
{
    ...
    void AddColumn(RevisionTablePropertyEnum PropertyType, string PropertySetId, object PropertyIdentifier,
        string Title, double Width, HorizontalTextAlignmentEnum TitleHorizontalJustification,

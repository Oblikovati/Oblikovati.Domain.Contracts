...
public interface IHeadlessDrawingDocument
{
    ...
    ISheets Sheets { get; }
    IDraftingStandard ActiveStandard { get; }
    ...
    void _GetReferenceInfo(out string DatabaseRevisionId, out string LastSavedLocation, out object Indices,
        out object OldPaths, out object CurrentPaths, bool SkipUnreferenced);
